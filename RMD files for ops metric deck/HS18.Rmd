...
Rto Closure Breach %
```{r ,echo=FALSE , results='asis'}
print(xtable(zz_rd_rto_pd_op2_hs18),type="html"  , include.rownames=FALSE)
```
Rto Closure Breach %
```{r ,echo=FALSE , results='asis'}
print(xtable(zz_rd_rto_pd_op2_hs18),type="html"  , include.rownames=FALSE)
...
Cycle
```{r ,echo=FALSE , results='asis'}
print(xtable(zz_rd_rto_pd_op4_hs18),type="html"  , include.rownames=FALSE)
```
...
Customer Returns
```{r ,echo=FALSE , results='asis'}
print(xtable(cust_ret_op3_hs18),type="html"  , include.rownames=FALSE)
```
...
Loss Rate
```{r ,echo=FALSE , results='asis'}
print(xtable(loss_rate_op2_hs18),type="html"  , include.rownames=FALSE)
```
...
```{r ,echo=FALSE , results='asis'}
print(xtable(dct_sum_op1_hs18),type="html"  , include.rownames=FALSE)
```
