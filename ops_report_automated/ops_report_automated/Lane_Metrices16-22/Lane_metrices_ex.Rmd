...
```{r , echo=FALSE, warning=FALSE}
#################Slide 16-22############################
zz_rep_16_22 = read.csv("~/R new/zz-rep-16-22.csv")
...
Lane_matrix = read.csv("~/R new/Lane-Matrix .csv")
...
zz_rep_16_op4_del = zz_rep_16_op4%>%
  filter(X_id.dl_occ=="Delhi NCR" , wkend_dt=="2015-04-11")%>%
  group_by(Tier)%>%
...
zz_rep_16_op4_bom = zz_rep_16_op4%>%
  filter(X_id.dl_occ=="Mumbai" , wkend_dt=="2015-04-11")%>%
  group_by(Tier)%>%
  summarize(Volume = sum(sum))
...
zz_rep_16_op4_blr = zz_rep_16_op4%>%
  filter(X_id.dl_occ=="Bangalore" , wkend_dt=="2015-04-11")%>%
  group_by(Tier)%>%
  summarize(Volume = sum(sum))
...
zz_rep_16_op4_ccu = zz_rep_16_op4%>%
  filter(X_id.dl_occ=="Kolkata" , wkend_dt=="2015-04-11")%>%
  group_by(Tier)%>%
  summarize(Volume = sum(sum))
...
zz_rep_16_op4_jai = zz_rep_16_op4%>%
  filter(X_id.dl_occ=="Jaipur" , wkend_dt=="2015-04-11")%>%
  group_by(Tier)%>%
  summarize(Volume= sum(sum))
...
zz_rep_16_op4_stv = zz_rep_16_op4%>%
  filter(X_id.dl_occ=="Surat" , wkend_dt=="2015-04-11")%>%
  group_by(Tier)%>%
  summarize(Volume= sum(sum))
...
zz_rep_16_op4_hyd = zz_rep_16_op4%>%
  filter(X_id.dl_occ=="Hyderabad" , wkend_dt=="2015-04-11")%>%
  group_by(Tier)%>%
  summarize(Volume = sum(sum))
